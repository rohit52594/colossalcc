							...
							<div class="table-responsive">
								<table class="table table-sm table-striped table-hover mb-0">
									...
									<tbody>
										<?php
										$i = 0;
										foreach ($RECENT_CUSTOMERS as $key) { ?>
											<tr>
												<td><?php echo ++$i; ?></td>
												<td><?php echo $key->name; ?></td>
												<td><?php echo $key->phone; ?></td>
												<td><?php echo $key->joined_date . ' - ' . $key->joined_time; ?></td>
												<td><span class="badge badge-pill badge-<?php echo ($key->is_verified == 1) ? 'success' : 'danger'; ?>"><?php echo ($key->is_verified == 1) ? 'Verified' : 'Not verified'; ?></span></td>
											</tr>
										<?php } ?>
									</tbody>
								</table>
