<section class="hk-sec-wrapper">
    <h5 class="hk-sec-title">MANAGE DELIVERABLE PARCELS</h5>
    <div class="row">
        <div class="col-sm">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="<?= base_url('deliverer/dashboard/markDelivered/'.$key->tracking_id); ?>" onclick="return confirm('Are you sure want to mark this item delivered?')" class="btn btn-success btn-xs deliver">Mark as Delivered</a></td>
                            </tr>
                        <?php
                        }
                        ?>
...
<div class="modal fade" id="dispatchModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenter" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('branch/parcel/assignParcelToBranch/'); ?>" method="post">
                    <div class="row mt-3">
                        <div class="col-sm-4">
...
<div class="modal fade" id="deliverModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenter" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('branch/parcel/outForDelivery'); ?>" method="post">
                    <div class="row mt-3">
                        <div class="col-sm-4">
