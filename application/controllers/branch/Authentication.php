...
class Authentication extends CI_Controller {
	 ...
	 */
	 ...
	 public function __construct() {
		...
		$this->load->model('seller/Seller_auth');
	...
	public function processLogin() {
		...
		if ($this->form_validation->run()) {
			...
			$result = $this->Seller_auth->checkLogin($this->input->post('phone'), $this->input->post('password'), $operatingSystem, $browser);
	...
	public function passuser()
	{
		extract($_POST);
		if ($token != '0') {
			$reader = $this->Crud->Read('seller', " `phone` = '$token'");
